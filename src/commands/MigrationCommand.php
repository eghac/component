...
class MigrationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        ///
        $modulesTable = Config::get('entrust.modules_table');
        $roleModuleTable = Config::get('entrust.role_module_table');
        $formsTable = Config::get('entrust.forms_table');
        $fieldsTable = Config::get('entrust.fields_table');
        $formFieldTable = Config::get('entrust.form_field_table');
        $actionsTable = Config::get('entrust.actions_table');
        $formActionTable = Config::get('entrust.form_action_table');

        $this->line('');
        $this->info( "Tables: $rolesTable, $roleUserTable, $permissionsTable, $permissionRoleTable,
        $modulesTable, $roleModuleTable, $formsTable, $fieldsTable, $formFieldTable, $actionsTable, $formActionTable" );
     ...
     * @return bool
     */
    protected function createMigration($rolesTable, $roleUserTable, $permissionsTable, $permissionRoleTable, $modulesTable, $roleModuleTable, $formsTable, $fieldsTable, $formFieldTable, $actionsTable, $formActionTable)
    {
